...
app.get('/api/stats', async (req, res) => {
    try {
        ...
        res.json({
            success: true,
            totalSheets: stats.total_planes || 0,
            totalMachinery: stats.total_maquinaria || 0,
            totalPersonnel: stats.total_personal || 0,
            totalTools: stats.total_herramientas || 0,
            totalSupplies: stats.total_insumos || 0,
            mantenimientosProgramados: stats.mantenimientos_programados || 0,
            mantenimientosEnProceso: stats.mantenimientos_en_proceso || 0
        });
    } catch (error) {
