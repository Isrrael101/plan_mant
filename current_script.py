...
TIPOS_MAQUINARIA = [
    'Excavadora Hidráulica', 'Cargador Frontal', 'Retroexcavadora', 'Bulldozer',
    'Motoniveladora', 'Rodillo Compactador', 'Camión Volquete', 'Grúa Móvil',
    'Martillo Hidráulico', 'Cargador de Ruedas', 'Minicargador', 'Tractor',
...
HERRAMIENTAS = [
    # Eléctricas
    ('Taladro Percutor', 'Herramientas Eléctricas'), ('Amoladora Angular', 'Herramientas Eléctricas'),
    ('Sierra Circular', 'Herramientas Eléctricas'), ('Martillo Perforador', 'Herramientas Eléctricas'),
    ('Atornillador Eléctrico', 'Herramientas Eléctricas'), ('Soldadora Inversora', 'Herramientas Eléctricas'),
    ('Pulidora', 'Herramientas Eléctricas'), ('Cizalla Eléctrica', 'Herramientas Eléctricas'),
    # Neumáticas
    ('Llave de Impacto Neumática', 'Herramientas Neumáticas'), ('Martillo Neumático', 'Herramientas Neumáticas'),
    ('Pistola de Pintura', 'Herramientas Neumáticas'), ('Llave de Torque', 'Herramientas Neumáticas'),
    # Manuales
    ...
    ('Multímetro Digital', 'Instrumentos'), ('Termómetro Infrarrojo', 'Instrumentos'),
    ('Manómetro', 'Instrumentos'), ('Calibrador Digital', 'Instrumentos'),
    # Especializadas
    ('Gato Hidráulico 20T', 'Equipos de Elevación'), ('Polipasto Manual', 'Equipos de Elevación'),
    ('Carretilla Hidráulica', 'Equipos de Elevación'), ('Transpaleta', 'Equipos de Elevación')
]

CATEGORIAS_INSUMOS = {
    'Lubricantes': [
        ('Aceite Hidráulico ISO 46', 'Litro', 15.50, 'Aceite de alta calidad'),
        ('Aceite Motor 15W-40', 'Litro', 12.75, 'Aceite multigrado'),
        ('Aceite Transmisión', 'Litro', 18.20, 'Aceite para transmisiones'),
        ('Grasa Multipropósito', 'Kg', 8.50, 'Grasa de uso general'),
        ('Grasa de Rodamientos', 'Kg', 9.75, 'Grasa especializada'),
        ('Aceite de Reductor', 'Litro', 16.80, 'Aceite para reductores')
    ],
    'Filtros': [
        ('Filtro de Aceite Motor', 'Unidad', 25.00, 'Filtro estándar'),
        ('Filtro de Aire Primario', 'Unidad', 35.50, 'Filtro de alta eficiencia'),
        ('Filtro de Aire Secundario', 'Unidad', 28.75, 'Filtro secundario'),
        ('Filtro Hidráulico', 'Unidad', 42.00, 'Filtro hidráulico'),
        ('Filtro de Combustible', 'Unidad', 22.50, 'Filtro de combustible')
    ],
    'Frenos': [
        ('Pastillas de Freno Delantero', 'Juego', 85.00, 'Pastillas cerámicas'),
        ('Pastillas de Freno Trasero', 'Juego', 75.50, 'Pastillas estándar'),
        ('Discos de Freno', 'Unidad', 120.00, 'Discos ventilados'),
        ('Líquido de Freno DOT 4', 'Litro', 18.75, 'Líquido de frenos')
    ],
    'Neumáticos': [
        ('Neumático 16.5R25', 'Unidad', 450.00, 'Neumático radial'),
        ('Neumático 23.5R25', 'Unidad', 680.00, 'Neumático para carga'),
        ('Neumático 14.00R24', 'Unidad', 520.00, 'Neumático estándar'),
        ('Cámara de Aire 16.5R25', 'Unidad', 85.00, 'Cámara interna')
    ],
    'Baterías': [
        ('Batería 12V 100Ah', 'Unidad', 145.00, 'Batería sellada'),
        ('Batería 12V 150Ah', 'Unidad', 195.00, 'Batería de alta capacidad'),
        ('Batería 24V 200Ah', 'Unidad', 380.00, 'Batería para maquinaria pesada')
    ],
    'Repuestos Eléctricos': [
        ('Alternador 12V 90A', 'Unidad', 280.00, 'Alternador estándar'),
        ('Motor de Arranque', 'Unidad', 320.00, 'Motor de arranque'),
        ('Fusibles Varios', 'Set', 15.50, 'Set de fusibles'),
        ('Cable de Batería', 'Metro', 12.00, 'Cable AWG 4')
    ],
    'Pinturas y Protección': [
        ('Pintura Epoxi Industrial', 'Galón', 85.00, 'Pintura anticorrosiva'),
        ('Primer Anticorrosivo', 'Galón', 72.00, 'Primer base'),
        ('Disolvente Universal', 'Galón', 28.50, 'Disolvente industrial')
    ],
    'Adhesivos y Selladores': [
        ('Sellador de Juntas', 'Tubo', 12.50, 'Sellador silicónico'),
        ('Adhesivo Epóxico', 'Unidad', 18.75, 'Adhesivo de dos componentes'),
        ('Cinta Téflon', 'Rollito', 3.50, 'Cinta para roscas')
    ]
}

CARGOS = [
    'Operador de Maquinaria', 'Mecánico Especialista', 'Técnico en Mantenimiento',
    'Supervisor de Mantenimiento', 'Jefe de Taller', 'Ingeniero de Mantenimiento',
    'Electricista Industrial', 'Soldador', 'Hidráulico', 'Especialista en Neumáticos',
    'Operador de Excavadora', 'Operador de Cargador', 'Operador de Retroexcavadora',
    'Operador de Bulldozer', 'Operador de Motoniveladora', 'Chofer de Camión',
...
NOMBRES = [
    ...
    'Miguel', 'Sofía', 'Javier', 'Patricia', 'Roberto', 'Elena', 'Fernando',
    'Isabel', 'Ricardo', 'Mónica', 'Antonio', 'Andrea', 'José', 'Lucía',
...
APELLIDOS = [
    ...
    'Gómez', 'Fernández', 'Díaz', 'Moreno', 'Alvarez', 'Romero', 'Ruiz', 'Jiménez',
    'Torres', 'Vargas', 'Mendoza', 'Herrera', 'Castro', 'Ramos', 'Ortega', 'Morales',
    'Delgado', 'Ramírez', 'Ortiz', 'Cruz', 'Reyes', 'Guerrero', 'Rivera'
]

ACTIVIDADES_MANTENIMIENTO = [
    ('Sistema Hidráulico', 'Revisar nivel y estado del aceite hidráulico', 30, 45, 60),
    ('Filtros', 'Inspeccionar y reemplazar filtros de aire, aceite y combustible', 20, 30, 45),
    ('Neumáticos', 'Verificar presión y estado de neumáticos', 15, 25, 35),
    ('Batería', 'Revisar carga y conexiones de batería', 10, 15, 20),
    ('Sistema de Frenos', 'Inspeccionar pastillas, discos y líquido de frenos', 30, 45, 60),
    ('Motor', 'Revisar nivel de aceite y refrigerante del motor', 15, 20, 30),
    ('Transmisión', 'Verificar nivel de aceite de transmisión', 10, 15, 20),
    ('Sistema Eléctrico', 'Revisar luces, conexiones y fusibles', 20, 30, 40),
    ('Lubricación', 'Aplicar grasa en puntos de lubricación', 20, 30, 45),
    ('Cuchillas y Herramientas', 'Inspeccionar y afilar cuchillas', 30, 45, 60),
    ('Sistema de Refrigeración', 'Revisar radiador y mangueras', 20, 30, 40),
    ('Carrocería', 'Inspección visual de estructura y carrocería', 15, 25, 35)
]
...
def generar_maquinaria(cursor, cantidad=250):
    ...
    años = [str(2010 + i) for i in range(15)]
    
    print(f"\n📦 Generando {cantidad} registros de maquinaria...")
    ...
    print(f"   ✅ {cantidad} registros de maquinaria generados")

def generar_personal(cursor, cantidad=180):
    """Genera registros de personal"""
    estados = ['ACTIVO', 'INACTIVO']
    
    print(f"\n👥 Generando {cantidad} registros de personal...")
    ...
    print(f"   ✅ {cantidad} registros de personal generados")

def generar_herramientas(cursor, cantidad=220):
    """Genera registros de herramientas"""
    estados = ['OPERATIVO', 'MANTENIMIENTO', 'INACTIVO']
    
    print(f"\n🔧 Generando {cantidad} registros de herramientas...")
    ...
    print(f"   ✅ {cantidad} registros de herramientas generados")

def generar_insumos(cursor, cantidad=250):
    """Genera registros de insumos"""
    print(f"\n📦 Generando {cantidad} registros de insumos...")
    ...
    print(f"   ✅ {cantidad} registros de insumos generados")
...
def generar_planes_mantenimiento(cursor):
    ...
    print(f"\n📅 Generando planes de mantenimiento preventivo por horas...")
    ...
    if not maquinarias:
        print("   ⚠️ No hay maquinaria disponible.")
        return
    ...
    for maquinaria_id, nombre_maq, codigo_maq in maquinarias:
        for horas in INTERVALOS_HORAS:
            ...
            descripcion = f"Plan de mantenimiento preventivo para {nombre_maq} ({codigo_maq}) cada {horas} horas de operación"
    ...
    print(f"   ✅ {total_planes} planes de mantenimiento preventivo generados ({len(INTERVALOS_HORAS)} por maquinaria)")

def generar_actividades_mantenimiento(cursor):
    """Genera actividades de mantenimiento para los planes"""
    print(f"\n⚙️ Generando actividades de mantenimiento...")
    
    cursor.execute("SELECT id FROM planes_mantenimiento WHERE activo = TRUE")
    planes = cursor.fetchall()
    
    if not planes:
        print("   ⚠️ No hay planes activos disponibles")
        return
...
def main():
    ...
    try:
        print("=" * 60)
        print("🚀 GENERADOR DE DATOS DE PRUEBA - MTTO PRO")
        print("=" * 60)
