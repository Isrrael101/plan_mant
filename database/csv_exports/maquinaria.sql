...
--
-- Host: localhost    Database: mtto_db
-- ------------------------------------------------------
...
CREATE TABLE `maquinaria` (
  ...
  `estado` enum('OPERATIVO','MANTENIMIENTO','INACTIVO') COLLATE utf8mb4_unicode_ci DEFAULT 'OPERATIVO',
...
-- Dump completed on 2025-12-03 16:19:22
