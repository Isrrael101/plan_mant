...
CREATE TABLE IF NOT EXISTS users (
    ...
    two_factor_secret VARCHAR(255) NULL COMMENT 'Secreto para Google Authenticator',
    two_factor_enabled BOOLEAN DEFAULT FALSE COMMENT 'Indica si 2FA está activado',
